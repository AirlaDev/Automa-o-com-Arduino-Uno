    ...
    while (client.connected())
    {
      if (client.available())
      {
        ...
        if (c == 'n')
        {
          ...
          client.println("</head>");
          client.println("<body>");
client.println("<div id='wrapper'><img alt='AUTOMATION' src='https://uploaddeimagens.com.br/images/001/299/062/original/banner-automacao.fw.png?1519172897'/><br/>");
